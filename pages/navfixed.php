...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="home.php">XYT Company</a>
	</div>
	<!-- /.navbar-header -->
				...
				<ul class="nav" id="side-menu">
					...
					<!-- <li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
								<a href="sales.php?id=cheque&invoice=<?php echo $finalcode ?>">Cheque</a>
							</li>
						</ul>
					</li> -->
					<li>
					...
					<li>
						...
						<ul class="nav nav-second-level">
							<li>
								<a href="accountreceivables.php">Cheque Payment List</a>
							</li>
							<li>
							...
							<li>
								<a  href="product_lose.php"> List of Damaged Products</a>
							</li>
							<li>
					...
					<li>
						<a href="#"><i class="fas fa-database"></i> Database<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li>
