...
if($d=='cheque') {
	$f = $_POST['due'];
	$sql = "INSERT INTO sales (invoice_number,cashier,date,type,total_amount,account_number,name,month,year,balance,p_amount,vat) VALUES (:a,:b,:c,:d,:e,:f,:g,:h,:i,:k,:j,:l)";
	$q = $db->prepare($sql);
